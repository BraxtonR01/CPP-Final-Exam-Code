...
/*
Pointers - MapTile class, tileInteract function, 
Classes (separating interface from implementation) - Mage, Character, and MapTile*
Inheritance - Mage and Character classes*
Polymorphism - line 60 through 64 in test*
Operator Overloading - MapTile class*
File Processing - inputMage and inputCharacter, test.cpp*
Function Template - line 24 declaration, used in line 179, test.cpp*
Arrays/Vectors - MapTile class*
*/
...
template <typename T>
void tileInteract(MapTile m, T* c) {
	cout << m << endl;
	int input = -1;
	while (input != 0) {
		do {
